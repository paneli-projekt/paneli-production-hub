...
**I-21 bNestova baza umjesto `.mno` datoteka (nalaz 18. 9. 2026.)** — na PANELI-PC radi SQL Server instanca `BNEST_2019` s bazama `bProcessbNest.mdf` i `bNestRover.mdf` (`C:\ProgramData\Biesse\bSqlDatabases\2019\`, žive — zadnja izmjena 9. 9. 2026.). Usporedba plana i stvarnog rezanja (35 §9) danas bi čitala `.mno` datoteke; čitanje te baze **samo za čitanje** dalo bi iste podatke bez skupljanja datoteka, a vjerojatno i vrijeme rezanja po ploči. Prije bilo čega: pregledati tablice na kopiji baze, nikad na živoj; Biesse ne jamči shemu pa se na to ne smije osloniti kritični dio.
