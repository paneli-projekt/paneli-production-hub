...
var Hub = (function () {
  ...
  ekrani.nalog_unos = async function (r) {
    ...
    var matHtml = d.materijali.map(function (x) {
      return '<div class="mat' + (x.id === S.nm ? " on" : "") + '" data-nm="' + x.id + '">' + (x.ident ? '<img class="dslika mat-sl" src="/api/dekor/slika/' + encodeURIComponent(x.ident) + '" alt="" loading="lazy" onerror="this.style.display=\'none\'">' : "") + '<div class="row"><b>' + esc(x.naziv_kratki || x.naziv_ulaz || "?") + '</b>' +
